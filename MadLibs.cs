...
namespace MadLibs
{
  class Program
  {
    ...
    {
      /*
      This program is word game call Mad Lips. It allows
      users to input words to fill in the story.
      Author: Charles Patterson
      */


      // Let the user know that the program is starting:
      Console.WriteLine("Welcome to Mad Libs! The game is now starting!");

      // Give the Mad Lib a title:
      string title = "Fairy Tale";
      ...
      Console.Write("Enter third and last adjective: ");
